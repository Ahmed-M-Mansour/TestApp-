...
.method private synthesizeSessionFile(Ljava/io/File;Ljava/lang/String;[Ljava/io/File;Ljava/io/File;)V
    ...
    .line 1430
    invoke-static {v3, p1}, Lcom/crashlytics/android/core/CrashlyticsController;->writeToCosFromFile(Lcom/crashlytics/android/core/CodedOutputStream;Ljava/io/File;)V
    ...
    invoke-virtual {v3, p1, v5, v6}, Lcom/crashlytics/android/core/CodedOutputStream;->writeUInt64(IJ)V

    const/4 p1, 0x5

    .line 1433
    invoke-virtual {v3, p1, v1}, Lcom/crashlytics/android/core/CodedOutputStream;->writeBool(IZ)V

    const/16 p1, 0xb

    .line 1435
    invoke-virtual {v3, p1, v0}, Lcom/crashlytics/android/core/CodedOutputStream;->writeUInt32(II)V
    ...
    .line 1437
    invoke-virtual {v3, p1, v0}, Lcom/crashlytics/android/core/CodedOutputStream;->writeEnum(II)V

    .line 1439
    invoke-direct {p0, v3, p2}, Lcom/crashlytics/android/core/CrashlyticsController;->writeInitialPartsTo(Lcom/crashlytics/android/core/CodedOutputStream;Ljava/lang/String;)V

    .line 1441
    invoke-static {v3, p3, p2}, Lcom/crashlytics/android/core/CrashlyticsController;->writeNonFatalEventsTo(Lcom/crashlytics/android/core/CodedOutputStream;[Ljava/io/File;Ljava/lang/String;)V

    if-eqz v1, :cond_3

    .line 1444
    invoke-static {v3, p4}, Lcom/crashlytics/android/core/CrashlyticsController;->writeToCosFromFile(Lcom/crashlytics/android/core/CodedOutputStream;Ljava/io/File;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .line 1454
    invoke-static {v3, p2}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V
...
.method private writeSessionPartFile(Ljava/lang/String;Ljava/lang/String;Lcom/crashlytics/android/core/CrashlyticsController$CodedOutputStreamWriteAction;)V
    ...
    invoke-static {v0, p3}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V
