...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/android/FlutterView$RenderMode;)V
    ...
    .line 163
    iget-object p1, p0, Lio/flutter/embedding/android/FlutterView;->flutterTextureView:Lio/flutter/embedding/android/FlutterTextureView;
...
.method public attachToFlutterEngine(Lio/flutter/embedding/engine/FlutterEngine;)V
    ...
    const-string v1, "Currently attached to a different engine. Detaching and then attaching to new engine."
...
.method public detachFromFlutterEngine()V
    ...
    const-string v2, "Detaching from a FlutterEngine: "
    ...
    const-string v1, "Not attached to an engine. Doing nothing."
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    const-string v1, "Updating window insets (fitSystemWindows()):\nStatus bar insets: Top: "
    ...
    iget v1, v1, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->paddingRight:I
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    const-string v2, "Updating window insets (onApplyWindowInsets()):\nStatus bar insets: Top: "
    ...
    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->paddingTop:I
    ...
    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->viewInsetLeft:I
    ...
    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->viewInsetRight:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, "System Gesture Insets - Left: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lio/flutter/embedding/android/FlutterView;->viewportMetrics:Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;

    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->systemGestureInsetLeft:I
    ...
    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->systemGestureInsetTop:I
    ...
    iget v2, v2, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ViewportMetrics;->systemGestureInsetRight:I
    ...
    invoke-static {p1, v1}, Lio/flutter/Log;->v(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected onSizeChanged(IIII)V
    ...
    const-string v2, "Size changed. Sending Flutter new viewport metrics. FlutterView was "
